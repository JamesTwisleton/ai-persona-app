    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                router.push(`/p/${convertToHyphenatedLowercase(formData.name)}`);
            }
        } catch (error) {
    ...
    return (
        <div className="max-w-lg mx-auto">
            <form onSubmit={handleSubmit}>
                {force ? null : <h2 className="text-4xl font-extrabold dark:text-white py-5">
            ...
            {isLoading === true ? <div>
                <div role="status" className="max-w-lg mx-auto pt-10 grid grid-cols-2">
